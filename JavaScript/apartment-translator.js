const itDictionary = {
    ...
    "rooms": "Ambienti",
    "location-title": "Dove si trova",
    "location-description": "Da Casa Kiki puoi raggiungere a piedi in 10 minuti i Giardini Pubblici, Castello, il Museo Archeologico Nazionale, il Bastione di Saint Remy, la Cattedrale, il Teatro Lirico, il Mercato di San Benedetto, il Parco della Musica e il Parco di Monte Claro. A pochi Km dalla casa si trovano la Spiaggia del Poetto (7 Km), il Parco di Molentargius (6 Km), il Porto di Cagliari (4 km), Aeroporto Cagliari-Elmas (12 km), la Fiera di Cagliari (4 km), Tribunale (3 km). Fermate del pullman<br>n°3, n°6, n°13, M",
    "map-text": "Mappa",
    "services-title": "Servizi",
    "services-description": "Casa Kiki è dotata di tutti i comfort per una spensierata e piacevole permanenza. Tra questi troviamo il posto auto, la zona lavanderia e molto altro. Ecco riportati i principali servizi.",
...
const enDictionary = {
    ...
    "rooms": "Rooms",
    "location-title": "How to reach it",
